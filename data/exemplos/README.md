...
| `sinteticos_processos.csv` | sim | 340 processos fictícios só com o que a base real tem (UF, sub-assunto, valor da causa, seis flags) mais o escritório (300 com decisão simulada em 3 escritórios + 40 no pool da "Banca Demo"). Sem autor, advogado ou sinais: nada inferido de documento (decisão 27). Lido por `make seed-demo` |
