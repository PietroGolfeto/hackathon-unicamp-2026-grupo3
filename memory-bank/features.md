...
| CI de PR: commits, memory-bank, segredos, testes por componente | — | Lucas | ✅ | `.github/workflows/ci.yml` (core: pytest; api: ruff + pytest com Postgres de serviço; web: tsc + build; compose: config); testes da API criam `enter_test` se faltar |
