...
| Benchmark de modelos da OpenAI na ficha do caso | 3 | P3 | ✅ | `src/extractor/extractor/benchmark.py`, `make benchmark-extractor`; 10 modelos × 2 casos × 3 (US$ 0,90, 3 min): 100% no gabarito com gpt-4.1-mini (US$ 0,006/caso, 5 s), gpt-4.1 (US$ 0,017, 4 s), gpt-5-mini (US$ 0,009, 55 s) e gpt-5.5 (US$ 0,084, 17 s); gpt-4o-mini 98% mas acha a contradição-chave em 1/3; gpt-5.4-mini 98% com 2 destaques de documento ausente; nanos 83–94% e erram decisão ou sub-assunto |
