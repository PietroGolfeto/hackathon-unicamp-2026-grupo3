...
Rodada real do extractor (prompt 2026-09-12.4, `make extrair`; gabarito de 17 critérios por caso sobre a saída crua do LLM; sinais finais após a reconciliação por regra):
| Modelo | Caso 01 tokens in+out · latência | Caso 02 tokens in+out · latência | Gabarito (LLM cru) | Sinais finais | Custo/caso |
|---|---|---|---|---|---|
| gpt-4o-mini (prompt .3) | 7.932 + 821 | 6.438 + 901 | 88% · 76%: inventa CREDITO_CONTA_TERCEIRO no caso 01, perde a contradição-chave nos dois, cita "[Dossiê]" inexistente | certos só pela regra | US$ 0,002 |
| gpt-4.1-mini | 8.485 + 1.151 · 11 s | 6.695 + 1.218 · 10 s | 100% · 88%: chama de "digital" a assinatura por biometria e deixa SEM_CONTRATO para a regra; sem tokens de raciocínio | certos nos dois casos (no caso 01 inventou LIVENESS_AUSENTE_CANAL_DIGITAL, apagado pela regra de canal) | US$ 0,005 |
| gpt-5-mini (padrão) | 8.483 + 2.724 (1.216 de raciocínio) · 32–50 s | 6.693 + 2.786 (1.152) · 34–47 s | 100% · 94–100% | certos nos dois casos; acrescenta CANAL_DIGITAL_SEM_PERFIL (caso 02) e OUTRO com o rastro TED/PIX/saque (caso 01) | US$ 0,0076 |
Nos dois modelos sobram 1–2 contradições fracas no caso 02 (canal digital que o autor nega; parcelas pagas × "jamais contratou") mesmo com a regra do prompt; a contradição-chave (conta na Caixa) e a do caso 01 (extrato × "jamais utilizou") saem certas. Trocar o padrão para gpt-4.1-mini (`OPENAI_MODEL`) corta a latência de ~40 s para ~10 s e o custo em 30% com os mesmos sinais finais; em aberto (decisão 35).
